...
export function OptionIcon({ option, ...props }: OptionIconProps) {
  return (
    <>
      {(option === "true" || option === true)
        ? <IncludedCircleIcon {...props} />
        : (option === "optional"
          ? <OptionalCircleIcon {...props} />
